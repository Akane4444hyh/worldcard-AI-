...
Open `flashcards.html` in your browser — double-click the file, or from the command line:
...
To regenerate from the Python template (after editing `generate_flashcards.py`):
